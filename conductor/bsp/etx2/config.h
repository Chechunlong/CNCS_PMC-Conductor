...
#define DEFAULT_BOOT_LINE \
	"ata=0,0(0,0)host:/cf/vxWorks e=192.168.0.32:ffffff00 h=192.168.0.49 g=192.168.0.1 u=anonymous pw=some@ tn=f8 s=/c/startup.sh"
...
#define SYS_WARM_ATA_CTRL       0       /* controller 1 for ETX module*/
...
/*
	1G Kingston
	cylinders = 123, Heads = 255, 63 sectors/track
*/

/* controller zero device zero */

#define ATA_CTRL0_DRV0_CYL  (123)   /* ATA 0, device 0 cylinders */
#define ATA_CTRL0_DRV0_HDS  (255)   /* ATA 0, device 0 heads */
#define ATA_CTRL0_DRV0_SPT  (63)    /* ATA 0, device 0 sectors per track */
