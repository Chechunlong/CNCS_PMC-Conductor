...
extern STATUS sysRtl81x9PciInit (
...
LOCAL VEND_ID_DESC vendorIdEnet [] =
    {
#if defined(INCLUDE_RTL_81X9_END)
    {RTL_VENDORID, sysRtl81x9PciInit},
#endif
    
    {0xffffffff, NULL}        /* last entry */
    };

extern END_OBJ * sysRtl81x9EndLoad
    (
    char * pParamStr,   /* ptr to initialization parameter string */
    void * unused       /* unused optional argument */
    );
extern END_OBJ * sysNe2000EndLoad
    (
...
#ifdef INCLUDE_RTL_81X9_END    
	{0, sysRtl81x9EndLoad, "", TRUE, NULL, FALSE},
	{1, sysRtl81x9EndLoad, "", TRUE, NULL, FALSE},
	{2, sysRtl81x9EndLoad, "", TRUE, NULL, FALSE},
#endif /* INCLUDE_RTL_81X9_END */
	{0, sysNe2000EndLoad, "", TRUE, NULL, FALSE},
	{1, sysNe2000EndLoad, "", TRUE, NULL, FALSE},
