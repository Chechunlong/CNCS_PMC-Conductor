...
#if !defined(PRJ_BUILD) && 0
/* note serial mode debug is enabled on vxworks only */
...
/* Default boot line */
#define BOOT_METHOD 3

#if BOOT_METHOD==1
#define DEFAULT_BOOT_LINE \
	"rtl(0,0)f8:/vxWorks h=10.1.0.116 e=10.1.0.4 g=10.1.0.1 u=anonymous pw=some@ tn=f8"
#elif BOOT_METHOD==2
/* boot from floppy */
#define DEFAULT_BOOT_LINE \
	"fd=0,0(0,0)host:/fd0/vxWorks h=90.0.0.3 e=90.0.0.50 u=target o=rtl0"	
#elif BOOT_METHOD==3
/* boot from hard disk */
#define DEFAULT_BOOT_LINE \
	"ata=1,0(0,0)host:/ata1a/vxworks e=192.168.0.32:ffffff00 h=192.168.0.49 g=192.168.0.1 u=anonymous pw=some@ tn=f8 s=/c/startup.sh"
#elif BOOT_METHOD==4
/* boot from hard disk, another method(not tested) */
#define DEFAULT_BOOT_LINE \
	"ata=0,0(0,0)host:/ata1a/vxWorks"
#endif
...
#define SYS_WARM_ATA_CTRL       1       /* controller 1 for ETX module*/
...
#define ATA1_INT_LVL      (0xf)       /* ATA 1 interrupt level */
 ...
 * hold them.
 */
#define SYSTEM_RAM_SIZE 0x03b00000 /*59MB memory on board */
