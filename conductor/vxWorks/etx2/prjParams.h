...
/*
GENERATED: Wed Jul 21 13:20:34 中国标准时间 2010
...
#undef INCLUDE_PCPENTIUM_PARAMS
#undef INCLUDE_POWER_MANAGEMENT
...
#define DEFAULT_BOOT_LINE "ata=0,0(0,0)host:/cf/vxWorks e=192.168.0.32:ffffff00 h=192.168.0.49 g=192.168.0.1 u=anonymous pw=some@ tn=f8 s=/c/startup.sh"
#undef  RESERVED
#define RESERVED 0
#undef  FREE_RAM_ADRS
...
#undef  PCI_MSTR_MEM_SIZE
#define PCI_MSTR_MEM_SIZE (0x0)
#undef  PCI_MSTR_MEM_BUS
#define PCI_MSTR_MEM_BUS (0x0)
#undef  PCI_MSTR_MEM_LOCAL
#define PCI_MSTR_MEM_LOCAL (0x0)
#undef  PCI_MSTR_IO_SIZE
#define PCI_MSTR_IO_SIZE (0x0)
#undef  PCI_MSTR_IO_BUS
#define PCI_MSTR_IO_BUS (0x0)
#undef  PCI_MSTR_IO_LOCAL
#define PCI_MSTR_IO_LOCAL (0x0)
#undef  PCI_MSTR_MEMIO_SIZE
#define PCI_MSTR_MEMIO_SIZE (0x0)
#undef  PCI_MSTR_MEMIO_BUS
#define PCI_MSTR_MEMIO_BUS (0x0)
#undef  PCI_MSTR_MEMIO_LOCAL
#define PCI_MSTR_MEMIO_LOCAL (0x0)
#undef  PCI_SLV_MEM_SIZE
#define PCI_SLV_MEM_SIZE (0x0)
#undef  PCI_SLV_MEM_BUS
#define PCI_SLV_MEM_BUS (0x0)
#undef  PCI_SLV_MEM_LOCAL
#define PCI_SLV_MEM_LOCAL (0x0)
#undef  PCI_SLV_IO_SIZE
#define PCI_SLV_IO_SIZE (0x0)
#undef  PCI_SLV_IO_BUS
#define PCI_SLV_IO_BUS (0x0)
#undef  PCI_SLV_IO_LOCAL
#define PCI_SLV_IO_LOCAL (0x0)
#undef  PCI_SLV_MEMIO_SIZE
#define PCI_SLV_MEMIO_SIZE (0x0)
#undef  PCI_SLV_MEMIO_BUS
#define PCI_SLV_MEMIO_BUS (0x0)
#undef  PCI_SLV_MEMIO_LOCAL
#define PCI_SLV_MEMIO_LOCAL (0x0)
#undef  SYS_CLK_RATE
#define SYS_CLK_RATE 60
#undef  SYS_CLK_RATE_MIN
#define SYS_CLK_RATE_MIN (19)
#undef  SYS_CLK_RATE_MAX
#define SYS_CLK_RATE_MAX (PIT_CLOCK/32)
#undef  NUM_TTY
...
#undef  INCLUDE_TIMESTAMP_PIT2
#undef  INCLUDE_TIMESTAMP_TSC
#define INCLUDE_TIMESTAMP_TSC
