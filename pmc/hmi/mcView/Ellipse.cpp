...
void CEllipse::Draw(CDC *pDC)
{
	...
	if(m_DnyAttr.m_FillH.m_Used || m_DnyAttr.m_FillV.m_Used){
		...
		CRgn rgn1;
		rgn1.CreateEllipticRgn(x1,y1,x2,y2);
		CRgn rgn2;
...
void CEllipse::Save(IXMLDOMElementPtr pRoot)
{
...
void CEllipse::Load(IXMLDOMElementPtr pGO)
{
    IXMLDOMElementPtr pStatic;
    IXMLDOMElementPtr pDynamic;
	IXMLDOMElementPtr pAttr;
...
void CEllipse::MoveElement(POINT potOffset)
{
