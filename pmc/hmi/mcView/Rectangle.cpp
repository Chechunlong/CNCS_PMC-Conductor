...
//////////////////////////////////////////////////////////////////////
IMPLEMENT_DYNAMIC(CRectangle,CElement)
...
void CRectangle::DrawTracker(CDC *pDC)
{
	LOGPEN tLogPen;
...
void CRectangle::DrawHotPoints(CDC *pDC)
{
...
long CRectangle::HitTest(long x, long y)
{
...
bool CRectangle::RInR(LPCRECT lpRect)
{
...
long CRectangle::Left()
{
	return m_lx1;
}

long CRectangle::Right()
{
	return m_lx2;
}
...
long CRectangle::Bottom()
{
	return m_ly2;
}

void CRectangle::Format(long left, long top, long right, long bottom, long flag)
{
	long ldx,ldy;
	switch(flag){
	case FM_A2L:
...
CElement * CRectangle::Clone(long lCmdId, long lStatus)
{
	CRectangle * pNew=new CRectangle();
...
void CRectangle::Save(IXMLDOMElementPtr pRoot)
{
    ...
    val.vt=VT_BSTR;
    val.bstrVal=::SysAllocString(L"rectangle");
...
void CRectangle::Load(IXMLDOMElementPtr pGO)
{
    IXMLDOMElementPtr pStatic;
    IXMLDOMElementPtr pDynamic;
	IXMLDOMElementPtr pAttr;
...
void CRectangle::MoveInCell(POINT potTracker)
{
	m_lx1+=potTracker.x;
	m_ly1+=potTracker.y;
	m_lx2+=potTracker.x;
...
void CRectangle::UpdateView()
{
	...
	if(m_DnyAttr.m_ColorBrushD.m_Used){
		if(m_DnyAttr.m_ColorBrushD.action_proc && m_DnyAttr.m_ColorBrushD.action_proc != (void*)-1){
			m_brush.lbColor = ((COLORREF(WINAPI*)())m_DnyAttr.m_ColorBrushD.action_proc)();
		}else if(m_DnyAttr.m_ColorBrushD.m_TagValue.Flags & TF_Valid){
...
void CRectangle::MoveElement(POINT potOffset)
{
