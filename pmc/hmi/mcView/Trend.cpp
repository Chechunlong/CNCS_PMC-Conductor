...
void CTrend::Load(IXMLDOMElementPtr pGO)
{
...
void CTrend::Save(IXMLDOMElementPtr pRoot)
{
...
void CTrend::config()
{
	...
	//trend 6
	dlg.m_tag6 = this->m_tagnames[5];
	dlg.m_ca6 = this->m_bAnalog[5];
	dlg.m_min6 = this->m_fMin[5];
	dlg.m_max6 = this->m_fMax[5];
	dlg.cuvColor[5] = this->m_pens[5].lopnColor;
	//trend 7
	dlg.m_tag7 = this->m_tagnames[6];
	dlg.m_ca7 = this->m_bAnalog[6];
	dlg.m_min7 = this->m_fMin[6];
	dlg.m_max7 = this->m_fMax[6];
	dlg.cuvColor[6] = this->m_pens[6].lopnColor;
	//trend 8
	dlg.m_tag8 = this->m_tagnames[7];
	dlg.m_ca8 = this->m_bAnalog[7];
	dlg.m_min8 = this->m_fMin[7];
	dlg.m_max8 = this->m_fMax[7];
	dlg.cuvColor[7] = this->m_pens[7].lopnColor;
	//trend 9
	dlg.m_tag9 = this->m_tagnames[8];
	dlg.m_ca9 = this->m_bAnalog[8];
	dlg.m_min9 = this->m_fMin[8];
	dlg.m_max9 = this->m_fMax[8];
	dlg.cuvColor[8] = this->m_pens[8].lopnColor;
	//trend 10
	dlg.m_tag10 = this->m_tagnames[9];
	dlg.m_ca10 = this->m_bAnalog[9];
	dlg.m_min10 = this->m_fMin[9];
	dlg.m_max10 = this->m_fMax[9];
	dlg.cuvColor[9] = this->m_pens[9].lopnColor;
	...
	if(dlg.DoModal()==IDOK){
		...
		this->m_pens[0].lopnColor = dlg.cuvColor[0];
		// trend 2
		this->m_tagnames[1] = dlg.m_tag2;
		this->m_bAnalog[1] = dlg.m_ca2;
		this->m_fMin[1] = dlg.m_min2;
		this->m_fMax[1] = dlg.m_max2;
		this->m_pens[1].lopnColor = dlg.cuvColor[1];
		// trend 3
		this->m_tagnames[2] = dlg.m_tag3;
		this->m_bAnalog[2] = dlg.m_ca3;
		this->m_fMin[2] = dlg.m_min3;
		this->m_fMax[2] = dlg.m_max3;
		this->m_pens[2].lopnColor = dlg.cuvColor[2];
		// trend 4
		this->m_tagnames[3] = dlg.m_tag4;
		this->m_bAnalog[3] = dlg.m_ca4;
		this->m_fMin[3] = dlg.m_min4;
		this->m_fMax[3] = dlg.m_max4;
		this->m_pens[3].lopnColor = dlg.cuvColor[3];
		// trend 5
		this->m_tagnames[4] = dlg.m_tag5;
		this->m_bAnalog[4] = dlg.m_ca5;
		this->m_fMin[4] = dlg.m_min5;
		this->m_fMax[4] = dlg.m_max5;
		this->m_pens[4].lopnColor = dlg.cuvColor[4];
		// trend 6
		this->m_tagnames[5] = dlg.m_tag6;
		this->m_bAnalog[5] = dlg.m_ca6;
		this->m_fMin[5] = dlg.m_min6;
		this->m_fMax[5] = dlg.m_max6;
		this->m_pens[5].lopnColor = dlg.cuvColor[5];
		// trend 7
		this->m_tagnames[6] = dlg.m_tag7;
		this->m_bAnalog[6] = dlg.m_ca7;
		this->m_fMin[6] = dlg.m_min7;
		this->m_fMax[6] = dlg.m_max7;
		this->m_pens[6].lopnColor = dlg.cuvColor[6];
		// trend 8
		this->m_tagnames[7] = dlg.m_tag8;
		this->m_bAnalog[7] = dlg.m_ca8;
		this->m_fMin[7] = dlg.m_min8;
		this->m_fMax[7] = dlg.m_max8;
		this->m_pens[7].lopnColor = dlg.cuvColor[7];
		// trend 9
		this->m_tagnames[8] = dlg.m_tag9;
		this->m_bAnalog[8] = dlg.m_ca9;
		this->m_fMin[8] = dlg.m_min9;
		this->m_fMax[8] = dlg.m_max9;
		this->m_pens[8].lopnColor = dlg.cuvColor[8];
		// trend 10
		this->m_tagnames[9] = dlg.m_tag10;
		this->m_bAnalog[9] = dlg.m_ca10;
		this->m_fMin[9] = dlg.m_min10;
		this->m_fMax[9] = dlg.m_max10;
		this->m_pens[9].lopnColor = dlg.cuvColor[9];
