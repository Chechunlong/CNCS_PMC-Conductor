...
$Archive: /PI/freeze/piut/pistatus.h $
...
$Log: /PI/freeze/piut/pistatus.h $

55    3/22/01 11:11a Matzen
...
enum {
   ...
   PI_PE_PCT_GOOD_TOO_SMALL        = -12330, /* future, really informative, runtime error codes */
   PI_PE_E31         = -12331,
   PI_PE_E32         = -12332,
   PI_PE_E33         = -12333,
   PI_PE_E34         = -12334,
...
void piut_msg (pistatus stat, TCHAR *pmsg, size_t *plength);
pibool piut_isgood (pistatus stat);
pibool piut_isbad (pistatus stat);
pibool piut_iswarning (pistatus stat);
void piut_ForceCrash ( TCHAR *pmsg );
#ifdef __cplusplus
}
...
const TCHAR* piut_parseversioninfo( int argc, char* argv[], PIvershelpdisplay showit = justreturn );
const pibool piut_IsUsageRequest ( int argc, char** argv, void(*usagefunc)(void)=0, 
                                         PIvershelpdisplay showit = justreturn );
const TCHAR* piut_GetVersionConstant( PIversionconstant vc );
#endif /* __cplusplus */
